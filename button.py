...
every_3hour = KeyboardButton('каждый 3 час')
...
buttons_key = ReplyKeyboardMarkup(resize_keyboard=True).add(every_hour, every_3hour, two_day, three_day).add(excel, stop)